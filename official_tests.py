...
def run_tests(seeds: List[int]):
    ...
    parameters_path = r"C:\Projetos\OAHF\Parameters\oahf_parameters.json"
    modified_path = r"C:\Projetos\OAHF\Parameters\oahf_parameters_modified.json"
    heuristic_definition_files = [r"C:\Projetos\OAHF\Parameters\heuristic_definition_hajr.json", r"C:\Projetos\OAHF\Parameters\heuristic_definition_iterative_hajr.json"]
    optimization_output_paths = [r"C:\Projetos\OAHF\Outputs\HAJR", r"C:\Projetos\OAHF\Outputs\Iterative_HAJR"]
...
if __name__ == "__main__":
    seed_path = Path(r"C:\Projetos\OAHF\Parameters\seeds.txt")
